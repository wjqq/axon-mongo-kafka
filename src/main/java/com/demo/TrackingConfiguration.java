...
public class TrackingConfiguration {
  ...
  public void configureStreamableKafkaSource(EventProcessingConfigurer configurer,
      ...
      configurer.registerTrackingEventProcessor("kafka-group", config->streamableKafkaMessageSource);
  }
  ...
  public StreamableKafkaMessageSource<String, byte[]> streamableKafkaMessageSource(
    ...
    return StreamableKafkaMessageSource.<String, byte[]>builder().topics(Arrays.asList("1122")) // Defaults
  ...
  public ConsumerFactory<String, byte[]> consumerFactory() {
    ...
    config.put(ConsumerConfig.GROUP_ID_CONFIG, "G111111");
